...
void view_log(void)
{
    ...
    if(event_count == 0)
    {
        clcd_print("Event Log", (0x80 + (0)));
        clcd_print("is Empty!", (0xC0 + (7)));
    ...
    else
    {
        ...
        if(k < event_count)
        {
            clcd_putch(k + '0', (0xC0 + (0)));
            clcd_putch(' ', (0xC0 + (1)));
            clcd_print(view_event[k], (0xC0 + (2)));
        }
...
void download_log(void)
{
    ...
    if(event_count != 0)
    {
        ...
        iter = 0;
        clcd_print("Log Downloaded", (0x80 + (0)));
        clcd_print("Successfully", (0xC0 + (3)));
    }
    else
    {
        clcd_print("Log is Empty!!", (0x80 + (0)));
    }
...
void set_time(void)
{
    ...
    if(set_delay++ < 600)
    {
        clcd_putch((hr / 10) + '0',(0xC0 + (0)));
        clcd_putch((hr % 10) + '0',(0xC0 + (1)));
        clcd_putch(':',(0xC0 + (2)));
        clcd_putch((min / 10) + '0',(0xC0 + (3)));
        clcd_putch((min % 10) + '0',(0xC0 + (4)));
        clcd_putch(':',(0xC0 + (5)));
        clcd_putch((sec / 10) + '0',(0xC0 + (6)));
        clcd_putch((sec % 10) + '0',(0xC0 + (7)));
    }
    ...
    if(key == 11)
    {
        ...
        set_flag = 0;
        clcd_write(0x01, 0);
        clcd_print("TIME SAVED", (0x80 + (3)));
        clcd_print("exiting...", (0xC0 + (0)));
        menu = 0;
        flag = 0;
        i = 0;
        _delay((unsigned long)((800)*(20000000/4000.0)));
    ...
    {
        clcd_write(0x01, 0);
        clcd_print("TIME NOT SAVED", (0x80 + (0)));
        clcd_print("exiting...", (0xC0 + (0)));
        menu = 0;
        flag = 0;
        i = 0;
